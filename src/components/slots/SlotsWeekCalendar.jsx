...
import SlotHoverPopover from "./SlotHoverPopover";
                                    ...
                                    >
                                        <Box
                                            sx={{
                                                ...
                                                border: "1px solid",
                                                borderColor:
                                                    slot.isActive === false ? "grey.400" : "primary.main",
                                                backgroundColor:
                                                    slot.isActive === false
                                                        ? "grey.100"
                                        ...
                                        >
                                            ...
                                            <Typography
                                                ...
                                                sx={{ display: "block" }}
                                            >
                                                {slot.slotType || "—"} • {participantCount}/
...
export { startOfWeek };
export default SlotsWeekCalendar;